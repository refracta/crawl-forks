...
enum ability_type
{
    ...
    ABIL_MAX_INTRINSIC = ABIL_SLIME_BOLT,
    ...
    // Jiyva
    ABIL_JIYVA_DISSOLUTION = 1130,
    ABIL_JIYVA_SET_TARGETS,
    ABIL_JIYVA_SLIMIFY,
    ABIL_JIYVA_SLIME_MOUNT,
    ABIL_JIYVA_SET_TARGETS_FREE,
    // Fedhas
