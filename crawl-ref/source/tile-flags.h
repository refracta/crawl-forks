...
enum tile_flags ENUM_INT64
{
    ...
    TILE_FLAG_SEALING_RUNE = 0x2000000000ULL,
    ...
    TILE_FLAG_CONFUSED     = 0x2000000000000ULL,
    ...
    // TILE_FLAG_DAZED        = 0x0000000000000000ULL,

    // Different levels of poison are mutually exclusive, so we can encode them in 2 bits.
    TILE_FLAG_POISON_MASK  = 0x8000000000800000ULL,
    TILE_FLAG_POISON       = 0x0000000000800000ULL,
    TILE_FLAG_MORE_POISON  = 0x8000000000000000ULL,
    TILE_FLAG_MAX_POISON   = 0x8000000000800000ULL,
