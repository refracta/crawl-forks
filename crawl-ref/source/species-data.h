...
{ SP_FELID, {
    ...
    4, 9, 11,
    { STAT_INT, STAT_DEX }, 5,
    { { MUT_ACUTE_VISION, 1, 1 }, { MUT_CARNIVOROUS, 1, 1 }, { MUT_CLAWS, 1, 1 }, { MUT_FANGS, 3, 1 }, { MUT_FAST, 1, 1 }, { MUT_PAWS, 1, 1 }, { MUT_SHAGGY_FUR, 1, 1 }, { MUT_SLOW_METABOLISM, 1, 1 }, { MUT_SHAGGY_FUR, 1, 6 }, { MUT_SHAGGY_FUR, 1, 12 } },
...
{ SP_GHOUL, {
    ...
    { "Your body is rotting away.", "You thrive on raw meat." },
    { "rotting body" },
...
{ SP_HIGH_ELF, {
    ...
    {},
    {},
    { JOB_HUNTER, JOB_ARCANE_MARKSMAN, JOB_GLADIATOR, JOB_SKALD, JOB_WIZARD, JOB_CONJURER, JOB_FIRE_ELEMENTALIST, JOB_ICE_ELEMENTALIST, JOB_AIR_ELEMENTALIST },
...
{ SP_KOBOLD, {
    ...
    {},
    {},
    { JOB_HUNTER, JOB_BERSERKER, JOB_ARCANE_MARKSMAN, JOB_ENCHANTER, JOB_CONJURER, JOB_SUMMONER },
...
{ SP_OGRE, {
    ...
    11, 9, 4,
    { STAT_STR }, 3,
    { { MUT_SUBDUED_MAGIC, 1, 1 }, { MUT_TOUGH_SKIN, 1, 1 }, { MUT_TOUGH_SKIN, 1, 4 }, { MUT_TOUGH_SKIN, 1, 7 }, { MUT_ROBUST, 1, 14 } },
    {},
    {},
    { JOB_HUNTER, JOB_BERSERKER, JOB_ARCANE_MARKSMAN, JOB_WIZARD, JOB_FIRE_ELEMENTALIST, JOB_SKALD },
...
{ SP_TROLL, {
    ...
    15, 4, 5,
    { STAT_STR }, 3,
    { { MUT_CLAWS, 3, 1 }, { MUT_FAST_METABOLISM, 3, 1 }, { MUT_GOURMAND, 1, 1 }, { MUT_REGENERATION, 1, 1 }, { MUT_SHAGGY_FUR, 1, 1 }, { MUT_TOUGH_SKIN, 3, 1 } },
    {},
    {},
...
{ SP_VAMPIRE, {
    ...
    7, 10, 9,
    { STAT_INT, STAT_DEX }, 5,
    { { MUT_ACUTE_VISION, 1, 1 }, { MUT_FANGS, 3, 1 }, { MUT_UNBREATHING, 1, 1 } },
    { "Your body is rotting away.", "You thrive on raw meat." },
    { "rotting body" },
