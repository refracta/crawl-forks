...
bool determine_chaos(const actor *agent, spell_type spell, bool random = true);
...
string spell_schools_string(spell_type spell, int *extra = nullptr);
string spell_hunger_string(spell_type spell, bool terse = false);
