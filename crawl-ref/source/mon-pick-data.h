...
{ // Dungeon (OOD cap: 27)
  ...
  {  4,  8,  400, PEAK, MONS_LLAIBWCA },
  {  4,  8,  250, PEAK, MONS_GWYBWCA },
  {  4,  8,  250, PEAK, MONS_CYSGOBWCA },
  {  4,  8,  100, PEAK, MONS_HAEARBWCA },
  ...
  {  6, 16,  335, SEMI, MONS_BONE_SCORPION },
...
{ // Orcish Mines
  ...
  {  1,  4,    2, FLAT, MONS_STURNULOS },
  {  1,  4,    2, FLAT, MONS_MYGDARTH },
  {  1,  4,    2, FLAT, MONS_SAELNEYTANDI },
...
{ // Elven Halls (OOD cap: 7)
  ...
  {  1,  7,  345, FLAT, MONS_CHAOS_ELEMENTAL },
  {  1,  7,  180, FLAT, MONS_PAIN_ELEMENTAL },
  {  1,  7,  180, FLAT, MONS_ROT_ELEMENTAL },
...
{ // Lair (OOD cap: 12)
  ...
  {  3,  6,  240, RISE, MONS_SWOOPING_MAGPIE },
  {  7, 12,  240, FLAT, MONS_SWOOPING_MAGPIE },
...
{ // Spider Nest
  ...
  {  1,  4,  550, FLAT, MONS_CEILING_CRAWLER },
  {  1,  4,  550, RISE, MONS_BONE_SCORPION },
...
{ // Crypt (OOD cap: 5)
  ...
  {  1,  5,   55, SEMI, MONS_SAELNEYTANDI },
  {  1,  6,  145, SEMI, MONS_EIDOLON },
  {  1,  6,  185, SEMI, MONS_ECTOPLASMIC_ORB },
...
{ // Hell
  ...
  {  1,  1,   89, FLAT, MONS_CYTHRAUL },
  {  1,  1,   89, FLAT, MONS_RYPUIWEL },
  {  1,  1,  515, FLAT, MONS_STURNULOS },
  {  1,  1,  515, FLAT, MONS_SAELNEYTANDI },
  {  1,  1,  515, FLAT, MONS_REAPER },
  {  1,  1,  300, FLAT, MONS_GIBBERING_MOUND },
  {  1,  1,   89, FLAT, MONS_LOROCYPROCA },
  {  1,  1,   25, FLAT, MONS_HELLION },
  {  1,  1,   25, FLAT, MONS_POENYDIO },
  {  1,  1,   89, FLAT, MONS_TAERINGU },
  {  1,  1,   52, FLAT, MONS_GWYRDD },
  {  1,  1,   52, FLAT, MONS_CENYSUS },
...
//{  4,  6,    4, SEMI, MONS_ANCIENT_LICH },
  ...
  {  1,  7, 1000, FLAT, MONS_HAEARBWCA },
  {  1,  2,    8, FALL, MONS_LLAIBWCA },
  {  1,  7, 1000, FLAT, MONS_TAERINGU },
  {  1,  7,  540, FALL, MONS_CYTHRAUL },
  {  1,  7,  335, FLAT, MONS_RYPUIWEL },
  {  1,  7,   25, PEAK, MONS_SAELNEYTANDI },
  {  1,  7,  900, FLAT, MONS_REAPER },
  {  1,  7,  775, FLAT, MONS_POENYDIO },
  {  1,  7,  100, FLAT, MONS_PAIN_ELEMENTAL },
  {  1,  7,  300, FLAT, MONS_HELLION },
  {  1,  7,  300, FLAT, MONS_GIBBERING_MOUND },
  {  4,  7,    4, FLAT, MONS_RHUDDGOCH },
  {  4,  7,    8, FLAT, MONS_CACODEMON },
...
{ // Gehenna
  ...
  {  1,  7,  192, FALL, MONS_LLAIBWCA },
  {  1, 12,  690, FALL, MONS_CYTHRAUL },
  { -1,  7,   89, PEAK, MONS_TAERINGU },
  {  3,  7,    8, PEAK, MONS_SAELNEYTANDI },
  {  1,  7,  590, FLAT, MONS_HELLION },
  {  1,  7,  365, FLAT, MONS_POENYDIO },
  {  1,  7,  100, FLAT, MONS_PAIN_ELEMENTAL },
  {  1,  7,  300, FLAT, MONS_GIBBERING_MOUND },
  {  1,  7,  192, FLAT, MONS_BALRUG },
  {  1,  9,  385, SEMI, MONS_REAPER },
  {  3,  7,   14, SEMI, MONS_GWARCHODWR },
  {  3,  7,    8, PEAK, MONS_RHUDDGOCH },
...
{ // Cocytus
  ...
  {  1,  7,  890, FLAT, MONS_GWYBWCA },
  {  1,  7,  890, FLAT, MONS_RYPUIWEL },
  {  1,  7,   81, PEAK, MONS_SAELNEYTANDI },
  {  1,  7,  285, FLAT, MONS_POENYDIO },
  {  1,  7,  100, FLAT, MONS_PAIN_ELEMENTAL },
  {  1,  7,  300, FLAT, MONS_GIBBERING_MOUND },
  {  1,  7,  192, FLAT, MONS_CENYSUS },
...
{ // Tartarus
  ...
  {  1,  7,  420, FLAT, MONS_PAIN_ELEMENTAL },
  {  1,  7,  200, FLAT, MONS_ROT_ELEMENTAL },
  ...
  {  1,  7,   89, FALL, MONS_LLAIBWCA },
  {  1,  7, 1000, FLAT, MONS_CYSGOBWCA },
  {  1,  7,   40, PEAK, MONS_CYTHRAUL },
  {  1,  7,  245, SEMI, MONS_RYPUIWEL },
  {  1,  9,  260, SEMI, MONS_SAELNEYTANDI },
  {  1,  7,  860, FLAT, MONS_REAPER },
  {  1,  7,  365, FLAT, MONS_POENYDIO },
  {  1,  7,  300, FLAT, MONS_GIBBERING_MOUND },
  {  1,  7,  365, FLAT, MONS_HELLION },
  {  1,  7,  365, FLAT, MONS_CYSGODOL },
...
{ // Abyss
  ...
  {  1,  5,  292, FLAT, MONS_CHAOS_ELEMENTAL },
  {  1,  7,   80, RISE, MONS_CHAOS_BUTTERFLY },
  {  1,  5,   89, FLAT, MONS_APOCALYPSE_CRAB },
  {  1,  5,  300, FLAT, MONS_RAIJU },
  {  1,  5,  152, FLAT, MONS_GIBBERING_MOUND },
  {  1,  8,  165, FALL, MONS_WORLDBINDER },
  {  1,  5,   52, FLAT, MONS_BOULDER_BEETLE },
  {  1,  5,   52, FLAT, MONS_VERY_UGLY_THING },
  {  1,  5,   52, FLAT, MONS_PAIN_ELEMENTAL },
  {  1,  5,   52, FLAT, MONS_ROT_ELEMENTAL },
  // Demons
  {  1,  4,   25, FALL, MONS_LLAIBWCA },
  {  1,  4,  192, FALL, MONS_GWYBWCA },
  {  1,  4,  192, FALL, MONS_QUASIT },
  {  1,  4,  192, FALL, MONS_UFETUBUS },
  {  1,  4,  192, FALL, MONS_HAEARBWCA },
  {  1,  4,   25, FALL, MONS_CYSGOBWCA },
  {  1,  5,    8, FALL, MONS_CYTHRAUL },
  {  1,  5,   25, FALL, MONS_RYPUIWEL },
  {  1,  5,   36, FALL, MONS_TAERINGU },
  {  1,  8,   73, FALL, MONS_VLERK },
  {  1,  8,   91, FALL, MONS_SIXFIRHY },
  {  1,  5,  125, FALL, MONS_NYCHDOD },
  {  1,  8,  315, FALL, MONS_YNOXINUL },
  {  1,  5,  225, FLAT, MONS_NEQOXEC },
  {  1,  5,  300, FLAT, MONS_MYGDARTH },
  {  1,  5,   22, FLAT, MONS_STURNULOS },
  {  1,  5,   14, FLAT, MONS_SAELNEYTANDI },
  {  1,  5,   25, FLAT, MONS_HELLION },
  {  1,  5,   25, FLAT, MONS_LOROCYPROCA },
  {  1,  5,   21, FLAT, MONS_POENYDIO },
  {  1,  5,   12, FLAT, MONS_REAPER },
  {  1,  5,   22, FLAT, MONS_GWYRDD },
  {  1,  5,   22, FLAT, MONS_CENYSUS },
  {  1,  5,   22, FLAT, MONS_BALRUG },
  {  1,  5,   25, FLAT, MONS_TITIVILUS },
  {  1, 10,   16, SEMI, MONS_CYSGODOL },
  {  1, 10,   16, SEMI, MONS_CACODEMON },
  {  1,  5,   25, FLAT, MONS_OXARMORDTH },
  {  1,  5,   10, FLAT, MONS_GWARCHODWR },
...
{ // Pandemonium - only used for 1 in 40 random Pan spawns (the rest are drawn
  ...
  {  1,  1,   25, FLAT, MONS_HELLEPHANT },
  {  1,  1, 1000, FLAT, MONS_NYCHDOD },
  {  1,  1, 1000, FLAT, MONS_VLERK },
  {  1,  1, 1000, FLAT, MONS_SIXFIRHY },
  {  1,  1,  670, FLAT, MONS_CYTHRAUL },
  {  1,  1,  335, FLAT, MONS_RYPUIWEL },
  {  1,  1,  335, FLAT, MONS_TAERINGU },
  {  1,  1, 1000, FLAT, MONS_YNOXINUL },
  {  1,  1,  400, FLAT, MONS_NEQOXEC },
  {  1,  1,  900, FLAT, MONS_MYGDARTH },
  {  1,  1,  335, FLAT, MONS_STURNULOS },
  {  1,  1,  335, FLAT, MONS_SAELNEYTANDI },
  {  1,  1, 1000, FLAT, MONS_BALRUG },
  {  1,  1, 1000, FLAT, MONS_CENYSUS },
  {  1,  1, 1000, FLAT, MONS_GWYRDD },
  {  1,  1, 1000, FLAT, MONS_TITIVILUS },
  {  1,  1,  335, FLAT, MONS_GIBBERING_MOUND },
  {  1,  1,  335, FLAT, MONS_HELLION },
  {  1,  1,  335, FLAT, MONS_POENYDIO },
  {  1,  1,  335, FLAT, MONS_REAPER },
  {  1,  1,  335, FLAT, MONS_CYSGODOL },
  {  1,  1,  335, FLAT, MONS_HELVITYR },
  {  1,  1,  335, FLAT, MONS_LOROCYPROCA },
  {  1,  1, 1000, FLAT, MONS_OXARMORDTH },
  {  1,  1,  335, FLAT, MONS_RHUDDGOCH },
  {  1,  1,  335, FLAT, MONS_VETRIFL },
  {  1,  1,  335, FLAT, MONS_GWARCHODWR },
  {  1,  1,  335, FLAT, MONS_TZITZIMITL },
  {  1,  7,  335, FLAT, MONS_CACODEMON },
...
{ // Sewer
  ...
  {  1,  1,  500, FLAT, MONS_WORM },
  {  1,  1,  500, FLAT, MONS_OOZE },
...
{ // Ice Cave
  ...
  {  1,  1,  515, FLAT, MONS_GWYBWCA },
  {  1,  1,  515, FLAT, MONS_RYPUIWEL },
...
{ // Depths (OOD cap: 14)
  ...
  {  1,  6,  250, RISE, MONS_CEILING_CRAWLER },
...
{ // Swamp water monsters
  ...
  {  1,  4,   100, FLAT, MONS_RAINBOW_TROUT },
  { 0,0,0,FLAT,MONS_0 }
};
