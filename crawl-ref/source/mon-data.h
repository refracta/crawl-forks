...

{
    ...
    MU_NOTHING, SIZE_GIANT, MON_SHAPE_BLOB,
...

{
    ...
    { { AT_HIT, AF_DRAIN_XP, 15 }, { AT_ENGULF, AF_ENGULF, 10 }, AT_NO_ATK, AT_NO_ATK },
    7, 395,
...

{
    ...
    { { AT_MULTIBITE, AF_ACID, 12 }, { AT_BITE, AF_VAMPIRIC, 22 }, AT_NO_ATK, AT_NO_ATK },
    18, 666,
    1, 3, MST_NO_SPELLS, CE_NOCORPSE, S_SILENT,
