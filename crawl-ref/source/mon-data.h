...
// minor demons: imps, etc. ('5')
{
    ...
    muf(MU_WEAPONS | MU_DOOR | MU_WAND), SIZE_LITTLE,
         MON_SHAPE_HUMANOID_WINGED,
    {TILEP_MONS_CRIMSON_IMP}, TILE_CORPSE_CRIMSON_IMP
},
...

{
    ...
    2, 110,
    4, 10, MST_WHITE_IMP, CE_DIVINE, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    muf(MU_DOOR | MU_WAND), SIZE_LITTLE,
         MON_SHAPE_HUMANOID_WINGED,
    {TILEP_MONS_WHITE_IMP}, TILE_CORPSE_WHITE_IMP
},
...

{
    ...
    {TILEP_MONS_IRON_IMP}, TILE_CORPSE_IRON_IMP
},

{
    ...
    { {AT_HIT, AF_PLAIN, 6}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    2, 110,
    3, 11, MST_SHADOW_IMP, CE_DIVINE, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    muf(MU_DOOR | MU_WAND), SIZE_LITTLE, MON_SHAPE_HUMANOID,
    {TILEP_MONS_SHADOW_IMP}, TILE_CORPSE_SHADOW_IMP
},
...
// devils etc. ('4')
{
    ...
    muf(MU_DOOR | MU_WAND), SIZE_MEDIUM, MON_SHAPE_HUMANOID,
    {TILEP_MONS_RUST_DEVIL}, TILE_CORPSE_RUST_DEVIL
},

{
    ...
    {TILEP_MONS_ORANGE_DEMON}, TILE_CORPSE_ORANGE_DEMON
},

{
    ...
    muf(MU_WEAPONS | MU_WAND), SIZE_MEDIUM,
        MON_SHAPE_HUMANOID_WINGED,
    {TILEP_MONS_RED_DEVIL}, TILE_CORPSE_RED_DEVIL
},

{
    ...
    {TILEP_MONS_HELLWING}, TILE_CORPSE_HELLWING
},

{
    ...
    {TILEP_MONS_ICE_DEVIL}, TILE_CORPSE_ICE_DEVIL
},
...
// middle demons ('3')
{
    ...
    I_HUMAN, HT_INCORPOREAL, 12, DEFAULT_ENERGY,
    MU_DOOR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
    {TILEP_MONS_SUN_DEMON}, TILE_CORPSE_SUN_DEMON
},

{
    ...
    11, 605,
    18, 19, MST_SOUL_EATER, CE_DIVINE, S_SILENT,
    I_HUMAN, HT_INCORPOREAL, 10, DEFAULT_ENERGY,
    muf(MU_DOOR | MU_WAND), SIZE_MEDIUM, MON_SHAPE_HUMANOID,
    {TILEP_MONS_SOUL_EATER}, TILE_CORPSE_SOUL_EATER
},

{
    ...
    { {AT_HIT, AF_PLAIN, 8}, {AT_HIT, AF_PLAIN, 5}, {AT_HIT, AF_PLAIN, 5},
       AT_NO_ATK },
    7, 385,
    5, 27, MST_SMOKE_DEMON, CE_DIVINE, S_ROAR,
    I_HUMAN, HT_INCORPOREAL, 10, DEFAULT_ENERGY,
    MU_DOOR, SIZE_SMALL, MON_SHAPE_HUMANOID,
    {TILEP_MONS_SMOKE_DEMON}, TILE_CORPSE_SMOKE_DEMON
},
...

{
    ...
    10, 550,
    7, 21, MST_SHADOW_DEMON, CE_DIVINE, S_CROAK,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    muf(MU_DOOR | MU_WAND), SIZE_SMALL, MON_SHAPE_HUMANOID,
    {TILEP_MONS_SHADOW_DEMON}, TILE_CORPSE_SHADOW_DEMON
},

{
    ...
    13, 715,
    5, 13, MST_GREEN_DEATH, CE_DIVINE, S_ROAR,
    I_HUMAN, HT_SLIME, 10, DEFAULT_ENERGY,
    muf(MU_DOOR | MU_WAND), SIZE_LARGE, MON_SHAPE_HUMANOID,
    {TILEP_MONS_GREEN_DEATH}, TILE_CORPSE_GREEN_DEATH
},

{
    ...
    12, 660,
    10, 31, MST_BLIZZARD_DEMON, CE_DIVINE, S_SHOUT,
    I_HUMAN, HT_INCORPOREAL, 10, DEFAULT_ENERGY,
    MU_DOOR, SIZE_LARGE, MON_SHAPE_HUMANOID,
    {TILEP_MONS_BLIZZARD_DEMON}, TILE_CORPSE_BLIZZARD_DEMON
},
...

{
    ...
    {TILEP_MONS_HELL_BEAST}, TILE_CORPSE_HELL_BEAST
},
...

{
    ...
    7, 385,
    12, 18, MST_TORMENTOR, CE_DIVINE, S_ROAR,
    I_HUMAN, HT_LAND, 13, DEFAULT_ENERGY,
    MU_DOOR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
    {TILEP_MONS_TORMENTOR}, TILE_CORPSE_TORMENTOR
},
...
// fiends, etc. ('1')
{
    ...
    MR_RES_POISON | MR_RES_DAMNATION | mrd(MR_RES_FIRE, 3) | MR_VUL_COLD
        | MR_VUL_WATER,
    17, MONS_BRIMSTONE_FIEND, MONS_BRIMSTONE_FIEND, MH_DEMONIC, 180,
    { {AT_HIT, AF_PLAIN, 25}, {AT_HIT, AF_PLAIN, 15}, {AT_HIT, AF_PLAIN, 15},
       AT_NO_ATK },
    18, 990,
    15, 33, MST_BRIMSTONE_FIEND, CE_DIVINE, S_ROAR,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    muf(MU_DOOR | MU_EVOKE), SIZE_LARGE, MON_SHAPE_HUMANOID_WINGED,
    {TILEP_MONS_BRIMSTONE_FIEND}, TILE_CORPSE_BRIMSTONE_FIEND
},

{
    ...
    MR_RES_POISON | MR_VUL_FIRE | mrd(MR_RES_COLD, 3),
    17, MONS_ICE_FIEND, MONS_ICE_FIEND, MH_DEMONIC, 180,
    { {AT_CLAW, AF_COLD, 25}, {AT_CLAW, AF_COLD, 25}, AT_NO_ATK, AT_NO_ATK },
    18, 990,
    15, 33, MST_ICE_FIEND, CE_DIVINE, S_ROAR,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    muf(MU_DOOR| MU_EVOKE | MU_WEAPONS), SIZE_LARGE, MON_SHAPE_HUMANOID_WINGED,
    {TILEP_MONS_ICE_FIEND}, TILE_CORPSE_ICE_FIEND
},
...

{
    ...
    10, MONS_HELL_SENTINEL, MONS_HELL_SENTINEL, MH_DEMONIC, 180,
    { {AT_HIT, AF_PLAIN, 40}, {AT_HIT, AF_PLAIN, 25}, AT_NO_ATK, AT_NO_ATK },
    19, 1425,
    25, 3, MST_HELL_SENTINEL, CE_DIVINE, S_ROAR,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    muf(MU_DOOR | MU_EVOKE), SIZE_LARGE, MON_SHAPE_HUMANOID,
    {TILEP_MONS_HELL_SENTINEL}, TILE_CORPSE_HELL_SENTINEL
},

{
    ...
    { {AT_HIT, AF_PLAIN, 30}, {AT_HIT, AF_PLAIN, 10}, {AT_HIT, AF_PLAIN, 10},
       AT_NO_ATK },
    12, 660,
    10, 41, MST_EXECUTIONER, CE_DIVINE, S_SCREAM,
    I_HUMAN, HT_STEEL, 20, DEFAULT_ENERGY,
    muf(MU_DOOR | MU_EVOKE), SIZE_LARGE, MON_SHAPE_HUMANOID,
    {TILEP_MONS_EXECUTIONER}, TILE_CORPSE_EXECUTIONER
},
