...
{
    MONS_ORC_WARMAGE, 'o', BLUE, "orc warmage",
    M_SEE_INVIS | M_SPEAKS | M_WARM_BLOOD,
    MR_NO_FLAGS,
    12, MONS_ORC, MONS_ORC, MH_NATURAL, 80,
    { {AT_HIT, AF_PLAIN, 7}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    15, 815,
    5, 16, MST_ORC_WARMAGE, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
    {TILEP_MONS_ORC_WARMAGE}, TILE_ERROR
},

{
    MONS_ORC_HIEROPHANT, 'o', LIGHTGREY, "orc hierophant",
    M_SEE_INVIS | M_SPEAKS | M_WARM_BLOOD,
    MR_NO_FLAGS,
    10, MONS_ORC, MONS_ORC, MH_NATURAL | MH_EVIL, 80,
    { {AT_HIT, AF_PLAIN, 16}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    15, 1050,
    5, 12, MST_ORC_HIEROPHANT, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
    {TILEP_MONS_ORC_HIEROPHANT}, TILE_ERROR
},
...
{
    MONS_BLORK_THE_WHINER, 'o', BROWN, "Blork the whiner",
    M_UNIQUE | M_WARM_BLOOD | M_SPEAKS | M_MALE,
    MR_NO_FLAGS,
    15, MONS_ORC, MONS_ORC, MH_NATURAL, 40,
    { {AT_HIT, AF_PLAIN, 20}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    7, 1120,
    4, 12, MST_BLORK_THE_WHINER, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
    {TILEP_MONS_BLORK_THE_WHINER}, TILE_ERROR
},

{
    MONS_BLORK_THE_REPENTANT, 'o', BROWN, "Blork the repentant",
    M_UNIQUE | M_WARM_BLOOD | M_SPEAKS | M_MALE,
    MR_NO_FLAGS,
    15, MONS_ORC, MONS_ORC, MH_NATURAL, 80,
    { {AT_HIT, AF_PLAIN, 25}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    15, 2350,
    6, 14, MST_BLORK_THE_REPENTANT, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
    {TILEP_MONS_BLORK_THE_REPENTANT}, TILE_ERROR
},

{
    MONS_BLORK_THE_GREAT_ORC, 'o', BROWN, "Blork the great orc",
    M_UNIQUE | M_WARM_BLOOD | M_SPEAKS | M_FAST_REGEN | M_MALE,
    MR_RES_FIRE | MR_RES_COLD | MR_RES_ELEC | MR_RES_NEG
		| MR_RES_POISON,
    15, MONS_ORC, MONS_ORC, MH_NATURAL, 160,
    { {AT_HIT, AF_PLAIN, 35}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    21, 3750,
    8, 16, MST_BLORK_THE_GREAT_ORC, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
    {TILEP_MONS_BLORK_THE_GREAT_ORC}, TILE_ERROR
},

{
    MONS_URUG_WARMASTER, 'o', RED, "Warmaster Urug",
    M_UNIQUE | M_FIGHTER | M_WARM_BLOOD | M_SPEAKS | M_FEMALE
        | M_SEE_INVIS | M_UNBLINDABLE | M_BLOOD_SCENT | M_TALL_TILE,
    MR_RES_POISON,
    15, MONS_ORC, MONS_ORC, MH_NATURAL, 80,
    { {AT_HIT, AF_PLAIN, 30}, {AT_BITE, AF_PLAIN, 20}, AT_NO_ATK, AT_NO_ATK },
    15, 1580,
    6, 13, MST_BATTLECRY, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 13, MISSILE_ENERGY(7),
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
    {TILEP_MONS_URUG_WARMASTER}, TILE_ERROR
},

{
    MONS_URUG_CHOSEN, 'o', RED, "Urug, the Eye of Beogh",
    M_UNIQUE | M_FIGHTER | M_WARM_BLOOD | M_SPEAKS | M_FEMALE
        | M_SEE_INVIS | M_UNBLINDABLE | M_BLOOD_SCENT | M_TALL_TILE,
    MR_RES_FIRE | MR_RES_COLD | MR_RES_NEG | MR_RES_ELEC
		| MR_RES_POISON,
    21, MONS_ORC, MONS_ORC, MH_NATURAL, 160,
    { {AT_HIT, AF_PLAIN, 30}, {AT_BITE, AF_PLAIN, 20}, {AT_BITE, AF_PLAIN, 20}, AT_NO_ATK },
    21, 3250,
    8, 13, MST_URUG_CHOSEN, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 13, MISSILE_ENERGY(7),
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
    {TILEP_MONS_URUG_CHOSEN}, TILE_ERROR
},

{
    MONS_NERGALLE_SOULEATER, 'o', WHITE, "Nergalle the Souleater",
    M_UNIQUE | M_SEE_INVIS | M_NO_ZOMBIE | M_SPEAKS | M_FEMALE,
    MR_RES_COLD | MR_RES_POISON | mrd(MR_RES_NEG, 3) | MR_RES_ROTTING,
    12, MONS_ORC, MONS_ORC, MH_NATURAL | MH_EVIL, 120,
    { {AT_HIT, AF_DRAIN_XP, 12}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    15, 1100,
    9, 11, MST_NERGALLE_SOULEATER, CE_NOXIOUS, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
    {TILEP_MONS_NERGALLE_SOULEATER}, TILE_ERROR
},

{
    MONS_NERGALLE_LICH, 'o', WHITE, "Nergalle the Orcish Lich",
    M_UNIQUE | M_SEE_INVIS | M_UNBREATHING | M_NO_ZOMBIE | M_SPEAKS | M_FEMALE,
    MR_RES_FIRE | MR_RES_COLD | MR_RES_ELEC,
    12, MONS_ORC, MONS_LICH, MH_UNDEAD | MH_EVIL, MAG_IMMUNE,
    { {AT_HIT, AF_DRAIN_XP, 24}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    21, 1800,
    9, 11, MST_NERGALLE_LICH, CE_NOCORPSE, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
    {TILEP_MONS_NERGALLE_LICH}, TILE_ERROR
},

{
    MONS_BAPTIZED_ROKA, 'o', LIGHTBLUE, "Roka the Twice Baptized",
    M_UNIQUE | M_FIGHTER | M_WARM_BLOOD | M_SPEAKS | M_MALE,
    MR_RES_FIRE | MR_RES_COLD | MR_RES_NEG | MR_RES_ELEC
		| MR_RES_POISON,
    15, MONS_ORC, MONS_ORC, MH_NATURAL | MH_EVIL, 180,
    { {AT_HIT, AF_PLAIN, 35}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    23, 3450,
    10, 13, MST_BAPTIZED_ROKA, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
    {TILEP_MONS_BAPTIZED_ROKA}, TILE_ERROR
},

{
    MONS_CHOSEN_WARRIOR, 'o', RED, "Chosen warrior of Beogh",
    ...
    { {AT_HIT, AF_PLAIN, 25},  {AT_HIT, AF_PLAIN, 25}, AT_NO_ATK, AT_NO_ATK },
    21, 2350,
    6, 10, MST_BATTLECRY, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
    {TILEP_MONS_CHOSEN_WARRIOR}, TILE_ERROR
},

{
    MONS_CHOSEN_MAGE, 'o', BLUE, "Chosen mage of Beogh",
    M_UNIQUE | M_WARM_BLOOD | M_SPEAKS | M_SEE_INVIS,
    MR_RES_FIRE | MR_RES_COLD | MR_RES_ELEC | MR_RES_NEG
		| MR_RES_POISON,
    15, MONS_ORC, MONS_ORC, MH_NATURAL, 160,
    { {AT_HIT, AF_PLAIN, 7}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    21, 1400,
    5, 16, MST_CHOSEN_MAGE, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, SPELL_ENERGY(2),
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
    {TILEP_MONS_CHOSEN_MAGE}, TILE_ERROR
},

{
    MONS_CHOSEN_PRIEST, 'o', LIGHTGREY, "Chosen priest of Beogh",
    M_UNIQUE | M_WARM_BLOOD | M_SPEAKS | M_SEE_INVIS,
    MR_RES_FIRE | MR_RES_COLD | MR_RES_ELEC | MR_RES_NEG
		| MR_RES_POISON,
    15, MONS_ORC, MONS_ORC, MH_NATURAL, 160,
    { {AT_HIT, AF_PLAIN, 20}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    21, 1850,
    5, 12, MST_CHOSEN_PRIEST, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
    {TILEP_MONS_CHOSEN_PRIEST}, TILE_ERROR
},
