...

{
    ...
    14, 770,
    6, 34, MST_NO_SPELLS, CE_NOCORPSE, S_SCREECH,
...
// angelic beings ('A')
{
    ...
    { {AT_HIT, AF_PLAIN, 25}, {AT_SHIELD, AF_PLAIN, 25}, {AT_HIT, AF_PLAIN, 10},
       AT_NO_ATK },
    12, 1020,
    10, 33, MST_ANGEL, CE_NOCORPSE, S_SHOUT,
    I_HUMAN, HT_LAND, 15, DEFAULT_ENERGY,
    MU_ALL, SIZE_MEDIUM,
...

{
    ...
    9, 765,
    10, 33, MST_BATTLECRY, CE_NOCORPSE, S_CHERUB,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MU_ALL, SIZE_MEDIUM,
        MON_SHAPE_HUMANOID_WINGED,
...

{
    ...
    25, 2125,
    10, 33, MST_SERAPH, CE_NOCORPSE, S_SHOUT,
    I_HUMAN, HT_LAND, 15, DEFAULT_ENERGY,
    MU_ALL, SIZE_MEDIUM,
        MON_SHAPE_HUMANOID_WINGED,
...

{
    ...
    14, 1190,
    10, 24, MST_DAEVA, CE_NOCORPSE, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MU_ALL, SIZE_MEDIUM,
        MON_SHAPE_HUMANOID_WINGED,
...

{
    ...
    18, 1530,
    10, 33, MST_NO_SPELLS, CE_NOCORPSE, S_SILENT,
    I_HUMAN, HT_LAND, 15, DEFAULT_ENERGY,
    MU_ALL, SIZE_MEDIUM,
        MON_SHAPE_HUMANOID_WINGED,
...

{
    ...
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    15, 975,
    10, 21, MST_OPHAN, CE_NOCORPSE, S_SILENT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MU_NOTHING, SIZE_MEDIUM, MON_SHAPE_ORB,
...
// spiritual beings ('R')
{
    ...
    { {AT_HIT, AF_PLAIN, 17}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    7, 385,
    10, 13, MST_EFREET, CE_NOCORPSE, S_SILENT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 20}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    11, 660,
    6, 21, MST_RAKSHASA, CE_NOCORPSE, S_SILENT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 45}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    15, 825,
    13, 21, MST_NO_SPELLS, CE_NOCORPSE, S_SILENT,
...
{   // BCADNOTE: Fakes being a derived undead but is its own thin
...
// minor demons: imps, etc. ('5')
{
    ...
    3, 135,
    3, 9, MST_BLINKER, CE_NOCORPSE, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
...

{
    ...
    3, 150,
    5, 12, MST_NO_SPELLS, CE_NOCORPSE, S_MOAN,
    I_HUMAN, HT_LAND, 13, DEFAULT_ENERGY,
...

{
    ...
    1, 70,
    2, 11, MST_NO_SPELLS, CE_NOCORPSE, S_SHOUT,
    I_HUMAN, HT_LAND, 15, DEFAULT_ENERGY,
    MU_DOOR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_STING, AF_REACH_STING, 15}, {AT_HIT, AF_WEAKNESS, 8}, AT_NO_ATK,
       AT_NO_ATK },
    8, 520,
    3, 13, MST_NO_SPELLS, CE_NOCORPSE, S_SCREECH,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
...

{
    ...
    7, 315,
    7, 19, MST_NO_SPELLS, CE_NOCORPSE, S_SILENT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
...

{
    ...
    7, 455,
    16, 21, MST_NO_SPELLS, CE_NOCORPSE, S_MOAN,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
...

{
    ...
    8, 440,
    12, 17, MST_NO_SPELLS, CE_NOCORPSE, S_SILENT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
...
// middle demons ('3')
{
    ...
    10, 550,
    10, 23, MST_NO_SPELLS, CE_NOCORPSE, S_SHOUT,
    I_HUMAN, HT_INCORPOREAL, 12, DEFAULT_ENERGY,
    MU_DOOR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    11, 605,
    18, 19, MST_SOUL_EATER, CE_NOCORPSE, S_SILENT,
    I_HUMAN, HT_INCORPOREAL, 10, DEFAULT_ENERGY,
    muf(MU_DOOR | MU_WAND), SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 8}, {AT_HIT, AF_PLAIN, 5}, {AT_HIT, AF_PLAIN, 5},
       AT_NO_ATK },
    7, 385,
    5, 27, MST_SMOKE_DEMON, CE_NOCORPSE, S_ROAR,
    I_HUMAN, HT_INCORPOREAL, 10, DEFAULT_ENERGY,
    MU_DOOR, SIZE_SMALL, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 15}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    6, 330,
    4, 17, MST_NEQOXEC, CE_NOCORPSE, S_SHOUT,
    I_HUMAN, HT_SLIME, 10, DEFAULT_ENERGY,
    muf(MU_WEAPONS | MU_WAND), SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 12}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    6, 330,
    3, 17, MST_YNOXINUL, CE_NOCORPSE, S_BELLOW,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
...

{
    ...
    9, 385,
    2, 33, MST_NO_SPELLS, CE_NOCORPSE, S_SILENT,
...

{
    ...
    10, 550,
    7, 21, MST_SHADOW_DEMON, CE_NOCORPSE, S_CROAK,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    muf(MU_DOOR | MU_WAND), SIZE_SMALL, MON_SHAPE_HUMANOID,
...

{
    ...
    13, 715,
    5, 13, MST_GREEN_DEATH, CE_NOCORPSE, S_ROAR,
    I_HUMAN, HT_SLIME, 10, DEFAULT_ENERGY,
...

{
    ...
    12, 660,
    10, 31, MST_BLIZZARD_DEMON, CE_NOCORPSE, S_SHOUT,
    I_HUMAN, HT_INCORPOREAL, 10, DEFAULT_ENERGY,
...

{
    ...
    14, 770,
    5, 21, MST_BALRUG, CE_NOCORPSE, S_SHOUT,
    I_HUMAN, HT_LAND, 12, DEFAULT_ENERGY,
...

{
    ...
    13, 975,
    11, 21, MST_TITIVILUS, CE_NOCORPSE, S_SHOUT,
    I_HUMAN, HT_SLIME, 10, DEFAULT_ENERGY,
    muf(MU_WEAPONS | MU_WAND | MU_DOOR), SIZE_LARGE, MON_SHAPE_HUMANOID,
    {TILEP_MONS_TITIVILUS}, TILE_ERROR
},

{
    ...
    { {AT_BITE, AF_PLAIN, 28}, {AT_TRAMPLE, AF_TRAMPLE, 20}, AT_NO_ATK,
       AT_NO_ATK },
    7, 840,
    5, 21, MST_NO_SPELLS, CE_NOCORPSE, S_RANDOM,
    I_HUMAN, HT_LAND, 15, DEFAULT_ENERGY,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 10}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    7, 385,
    5, 23, MST_HELLION, CE_NOCORPSE, S_SCREAM,
    I_HUMAN, HT_LAND, 12, DEFAULT_ENERGY,
    MU_DOOR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    14, 770,
    10, 18, MST_NO_SPELLS, CE_NOCORPSE, S_MOAN,
    I_HUMAN, HT_INCORPOREAL, 10, DEFAULT_ENERGY,
    muf(MU_DOOR | MU_WAND), SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    7, 385,
    12, 18, MST_TORMENTOR, CE_NOCORPSE, S_ROAR,
    I_HUMAN, HT_LAND, 13, DEFAULT_ENERGY,
    MU_DOOR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...
// fiends, etc. ('1')
{
    ...
    { {AT_HIT, AF_PLAIN, 25}, {AT_HIT, AF_PLAIN, 15}, {AT_HIT, AF_PLAIN, 15},
       AT_NO_ATK },
    18, 990,
    15, 33, MST_BRIMSTONE_FIEND, CE_NOCORPSE, S_ROAR,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
...

{
    ...
    18, 990,
    15, 33, MST_ICE_FIEND, CE_NOCORPSE, S_ROAR,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
...

{
    ...
    18, 666,
    8, 48, MST_CACODEMON, CE_NOCORPSE, S_ROAR,
...

{
    ...
    { {AT_ENGULF, AF_DRAIN_SPEED, 25}, {AT_BITE, AF_ROT, 25},
      AT_NO_ATK, AT_NO_ATK },
    22, 1050,
    12, 38, MST_TZITZIMITL, CE_NOCORPSE, S_ROAR,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 30}, {AT_HIT, AF_PLAIN, 10}, {AT_HIT, AF_PLAIN, 10},
       AT_NO_ATK },
    12, 660,
    10, 41, MST_EXECUTIONER, CE_NOCORPSE, S_SCREAM,
...
// "A"ngels.
{
    ...
    { {AT_HIT, AF_PLAIN, 30}, {AT_SHIELD, AF_PLAIN, 30}, 
      {AT_HIT, AF_PLAIN, 20}, AT_NO_ATK },
    19, 1520,
    15, 44, MST_MENNAS, CE_NOCORPSE, S_SILENT,
    I_HUMAN, HT_LAND, 15, DEFAULT_ENERGY,
    muf(MU_MELEE | MU_WAND), SIZE_MEDIUM,
        MON_SHAPE_HUMANOID_WINGED,
...

{
    ...
    { {AT_MULTIBITE, AF_FIRE, 35}, {AT_CLAW, AF_PLAIN, 15},
      {AT_TRAMPLE, AF_TRAMPLE, 15}, AT_NO_ATK },
    17, 2805,
    16, 18, MST_SERPENT_OF_HELL_GEH, CE_NOCORPSE, S_LOUD_ROAR,
    I_HUMAN, HT_LAND, 14, DEFAULT_ENERGY,
...

{
    ...
    { {AT_MULTIBITE, AF_COLD, 35}, {AT_CLAW, AF_PLAIN, 15},
      {AT_TRAMPLE, AF_TRAMPLE, 15}, AT_NO_ATK },
    17, 2805,
    20, 18, MST_SERPENT_OF_HELL_COC, CE_NOCORPSE, S_LOUD_ROAR,
    I_HUMAN, HT_LAND, 14, DEFAULT_ENERGY,
    MU_NOTHING, SIZE_GIANT, MON_SHAPE_QUADRUPED_WINGED,
...

{
    ...
    17, 3230,
    30, 11, MST_SERPENT_OF_HELL_DIS, CE_NOCORPSE, S_LOUD_ROAR,
    I_HUMAN, HT_LAND, 14, DEFAULT_ENERGY,
    MU_NOTHING, SIZE_GIANT, MON_SHAPE_QUADRUPED_WINGED,
...

{
    ...
    { {AT_MULTIBITE, AF_DRAIN_XP, 35}, {AT_CLAW, AF_PLAIN, 15},
      {AT_TRAMPLE, AF_TRAMPLE, 15}, AT_NO_ATK },
    17, 3230,
    16, 18, MST_SERPENT_OF_HELL_TAR, CE_NOCORPSE, S_LOUD_ROAR,
    I_HUMAN, HT_LAND, 14, DEFAULT_ENERGY,
    MU_NOTHING, SIZE_GIANT, MON_SHAPE_QUADRUPED_WINGED,
...
// Rakshasas and demons.
{
    ...
    { {AT_HIT, AF_PLAIN, 17}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    11, 880,
    10, 17, MST_AZRAEL, CE_NOCORPSE, S_SILENT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 30}, {AT_SHIELD, AF_PLAIN, 30}, AT_NO_ATK, AT_NO_ATK },
    18, 1440,
    10, 31, MST_MARA, CE_NOCORPSE, S_SILENT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    muf(MU_MELEE | MU_EVOKE), SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...
// Abominations
{
    ...
    15, 1265,
    5, 5, MST_NO_SPELLS, CE_NOCORPSE, S_MOAN,
    I_HUMAN, HT_AMPHIBIOUS, 10, DEFAULT_ENERGY,
    MU_DOOR, SIZE_GIANT, MON_SHAPE_MISC,
    {TILEP_MONS_GAMMAFUNK}, TILE_ERROR
},
...
// numbers!
{
    ...
    { {AT_HIT, AF_PLAIN, 20}, {AT_HIT, AF_PLAIN, 10}, {AT_HIT, AF_PLAIN, 10},
      {AT_HIT, AF_PLAIN, 5} },
    18, 2520,
    10, 33, MST_IGNACIO, CE_NOCORPSE, S_SHOUT,
    I_HUMAN, HT_LAND, 20, DEFAULT_ENERGY,
...

{
    ...
    6, 390,
    3, 8, MST_GRINDER, CE_NOCORPSE, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MU_DOOR, SIZE_LITTLE, MON_SHAPE_HUMANOID,
...
// unique major demons ('&')
{
    ...
    17, 3485,
    10, 50, MST_MNOLEG, CE_NOCORPSE, S_BUZZ,
...

{
    ...
    19, 3895,
    10, 44, MST_LOM_LOBON, CE_NOCORPSE, S_SCREAM,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    muf(MU_DOOR | MU_WAND), SIZE_LARGE, MON_SHAPE_HUMANOID,
    {TILEP_MONS_LOM_LOBON, TVARY_FOOL}, TILE_ERROR
},

{
    ...
    21, 6510,
    30, 12, MST_CEREBOV, CE_NOCORPSE, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 45}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    16, 3520,
    10, 22, MST_GLOORX_VLOQ, CE_NOCORPSE, S_MOAN,
    I_HUMAN, HT_LAND, 20, DEFAULT_ENERGY,
    muf(MU_DOOR | MU_WAND), SIZE_LARGE, MON_SHAPE_HUMANOID,
...

{
    ...
    17, 4505,
    30, 11, MST_ASMODEUS, CE_NOCORPSE, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MU_ALL, SIZE_LARGE, MON_SHAPE_HUMANOID,
...

{
    ...
    18, 3510,
    10, 47, MST_ERESHKIGAL, CE_NOCORPSE, S_SHOUT,
    I_HUMAN, HT_LAND, 14, DEFAULT_ENERGY,
