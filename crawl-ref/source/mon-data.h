...

{
    ...
    M_CONFUSED | M_INSUBSTANTIAL | M_CONJURED | M_FLIES | M_NO_EXP_GAIN,
    MR_RES_FIRE | MR_RES_COLD | MR_RES_ELEC | mrd(MR_RES_ACID, 3),
    5, MONS_FIRE_VORTEX, MONS_CHAOS_VORTEX, MH_NONLIVING, MAG_IMMUNE,
...

{
    ...
    M_SEE_INVIS,
    M_NO_FLAGS,
    12, MONS_CHAOS_ELEMENTAL, MONS_CHAOS_ELEMENTAL, MH_NONLIVING, 60,
...

{
    ...
    12, MONS_JELLY, MONS_LAVA_GLOB, MH_NONLIVING, 160,
...

{
    ...
    20, MONS_JELLY, MONS_SLIME_REMNANT, MH_NONLIVING, 180,
...

{
    ...
    14, MONS_REAPER, MONS_REAPER, MH_NONLIVING, 100,
    { {AT_HIT, AF_PLAIN, 45}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    14, 770,
...
// to examine them.
{
    ...
    10, MONS_DANCING_WEAPON, MONS_DANCING_WEAPON, MH_NONLIVING, 180,
    { {AT_HIT, AF_PLAIN, 30}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    15, 150,
...

{
    ...
    M_NO_FLAGS,
    MR_VUL_ACID,
    10, MONS_GOLEM, MONS_SALTLING, MH_NONLIVING, 160,
    { {AT_HIT, AF_PLAIN, 20}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    8, 270,
...

{
    ...
    M_SEE_INVIS,
    MR_RES_FIRE | MR_RES_COLD | MR_RES_ELEC | MR_VUL_ACID,
    10, MONS_GOLEM, MONS_PEACEKEEPER, MH_NONLIVING, 180,
...

{
    ...
    M_NO_FLAGS,
    mrd(MR_RES_FIRE | MR_RES_COLD | MR_RES_ELEC, 3) | MR_VUL_ACID,
    10, MONS_GOLEM, MONS_IRON_GOLEM, MH_NONLIVING, 180,
    { {AT_HIT, AF_PLAIN, 35}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    15, 1350,
...

{
    ...
    10, MONS_GOLEM, MONS_CRYSTAL_GUARDIAN, MH_NONLIVING, 200,
    { {AT_HIT, AF_PLAIN, 35}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    16, 640,
...

{
    ...
    M_NO_FLAGS,
    MR_RES_FIRE | MR_RES_COLD | MR_RES_ELEC | MR_VUL_ACID,
    10, MONS_GOLEM, MONS_TOENAIL_GOLEM, MH_NONLIVING, 140,
...

{
    ...
    12, MONS_GOLEM, MONS_ELECTRIC_GOLEM, MH_NONLIVING, 180,
...

{
    ...
    M_FIGHTER | M_SEE_INVIS,
    MR_RES_FIRE | MR_RES_COLD | MR_RES_ELEC | MR_VUL_ACID,
    10, MONS_GOLEM, MONS_USHABTI, MH_NONLIVING, 160,
    { {AT_HIT, AF_PLAIN, 30}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    7, 455,
...

{
    ...
    10, MONS_GOLEM, MONS_GUARDIAN_GOLEM, MH_NONLIVING, 160,
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    5, 400,
...

{
    ...
    10, MONS_GOLEM, MONS_SPELLFORGED_SERVITOR, MH_NONLIVING, 160,
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    8, 800,
...
// statues and statue-like things (also '8')
{
    ...
    10, MONS_STATUE, MONS_ICE_STATUE, MH_NONLIVING, 160,
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    8, 720,
...

{
    ...
    mrd(MR_RES_FIRE | MR_RES_COLD, 2) | MR_RES_ELEC
        | MR_RES_PETRIFY | MR_VUL_ACID,
    10, MONS_STATUE, MONS_OBSIDIAN_STATUE, MH_NONLIVING | MH_EVIL, 160,
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    10, 700,
...

{
    ...
    mrd(MR_RES_FIRE | MR_RES_COLD, 2) | MR_RES_ELEC | MR_RES_PETRIFY
        | MR_VUL_ACID,
    10, MONS_STATUE, MONS_ORANGE_STATUE, MH_NONLIVING, 180,
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    10, 700,
...
{ // always redefined
    ...
    10, MONS_STATUE, MONS_STATUE, MH_NONLIVING, 120,
...

{
    ...
    M_STATIONARY,
    MR_RES_PETRIFY,
    10, MONS_TRAINING_DUMMY, MONS_TRAINING_DUMMY, MH_NONLIVING, 90,
...

{
    ...
    mrd(MR_RES_FIRE | MR_RES_COLD, 2) | mrd(MR_RES_ELEC, 3) | MR_RES_PETRIFY
        | MR_VUL_ACID,
    10, MONS_LIGHTNING_SPIRE, MONS_LIGHTNING_SPIRE, MH_NONLIVING, 160,
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    3, 210,
...

{
    ...
    13, MONS_ORB_OF_FIRE, MONS_ORB_OF_FIRE, MH_NONLIVING, 190,
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    30, 1500,
...
{ // not an actual monster, used by a spell
    ...
    | M_CONJURED | M_FLIES,
    mrd(MR_RES_FIRE, 3) | MR_RES_STICKY_FLAME,
    0, MONS_FOXFIRE, MONS_EPHEMERAL_SPIRIT, MH_NONLIVING, MAG_IMMUNE,
    { { AT_HIT, AF_PLAIN, 1 }, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    1, 10, /* unkillable */
    0, 10, MST_NO_SPELLS, CE_NOCORPSE, S_SILENT,
    I_BRAINLESS, HT_LAND, 50, DEFAULT_ENERGY,
...

{
    ...
    13, MONS_WRETCHED_STAR, MONS_WRETCHED_STAR, MH_NONLIVING, 160,
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    10, 700,
...

{
    ...
    M_SEE_INVIS | M_FLIES | M_SPELLCASTER,
    mrd(MR_RES_FIRE | MR_RES_COLD | MR_RES_ELEC, 3) | MR_VUL_ACID,
    13, MONS_SILVER_STAR, MONS_SILVER_STAR, MH_NONLIVING, 180,
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    12, 420,
...

{
    ...
    mrd(MR_RES_FIRE | MR_RES_COLD, 2) | MR_RES_ELEC
        | MR_RES_PETRIFY | MR_VUL_ACID,
    10, MONS_STATUE, MONS_STATUE, MH_NONLIVING, 160,
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    14, 1820,
