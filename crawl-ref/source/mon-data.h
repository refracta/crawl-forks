...

{
    ...
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    2, 300,
    4, 25, MST_NO_SPELLS, CE_NOXIOUS, S_BUZZ,
    I_BRAINLESS, HT_LAND, 25, DEFAULT_ENERGY,
...

{
    ...
    8, 330,
    6, 16, MST_NO_SPELLS, CE_CLEAN, S_SCREECH,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 30}, {AT_SHIELD, AF_PLAIN, 30}, 
      {AT_TAIL_SLAP, AF_PLAIN, 15}, AT_NO_ATK },
    14, 780,
    24, 6, MST_NO_SPELLS, CE_NOCORPSE, S_ROAR,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    muf(MU_ALL | MU_THROW_JAVELIN | MU_THROW_NET), SIZE_MEDIUM,
        MON_SHAPE_HUMANOID_TAILED,
...

{
    ...
    AT_NO_ATK },
    14, 980,
    9, 18, MST_NO_SPELLS, CE_NOCORPSE, S_ROAR,
...

{
    ...
    { { AT_HIT, AF_PLAIN, 25 }, {AT_SHIELD, AF_PLAIN, 25}, AT_NO_ATK, AT_NO_ATK },
    14, 980,
    16, 14, MST_NO_SPELLS, CE_CLEAN, S_ROAR,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    muf(MU_ALL | MU_THROW_JAVELIN | MU_THROW_NET), SIZE_MEDIUM,
    MON_SHAPE_HUMANOID_TAILED,
...

{
    ...
    { { AT_HIT, AF_PLAIN, 25 }, {AT_SHIELD, AF_PLAIN, 25}, AT_NO_ATK, AT_NO_ATK },
    14, 980,
    9, 18, MST_NO_SPELLS, CE_CLEAN, S_ROAR,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    muf(MU_ALL | MU_THROW_JAVELIN | MU_THROW_NET), SIZE_MEDIUM,
    MON_SHAPE_HUMANOID_TAILED,
...

{
    ...
    6, 260,
    6, 12, MST_NO_SPELLS, CE_CLEAN, S_HOWL,
    I_ANIMAL, HT_LAND, 13, DEFAULT_ENERGY,
    MU_NOTHING, SIZE_LARGE, MON_SHAPE_QUADRUPED,
...

{
    ...
    AT_NO_ATK, AT_NO_ATK },
    7, 295,
    2, 28, MST_BLINKER, CE_NOCORPSE, S_HOWL,
...

{
    ...
    13, 780,
    0, 14, MST_MERFOLK_JAVELINEER, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_AMPHIBIOUS, 10, SWIM_ENERGY(6),
...

{
    ...
    { { AT_HIT, AF_PLAIN, 7 }, {AT_SHIELD, AF_PLAIN, 7}, AT_NO_ATK, AT_NO_ATK },
    14, 550,
    1, 12, MST_ORC_CLERIC, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MU_ALL, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    8, 280,
    5, 14, MST_NO_SPELLS, CE_CLEAN, S_HISS,
    I_ANIMAL, HT_LAND, 15, DEFAULT_ENERGY,
    MU_NOTHING, SIZE_SMALL, MON_SHAPE_ARACHNID,
...

{
    ...
    { {AT_POUNCE, AF_ENSNARE, 20}, {AT_BITE, AF_PLAIN, 8}, AT_NO_ATK,
       AT_NO_ATK },
    8, 320,
    7, 12, MST_JUMPING_SPIDER, CE_NOXIOUS, S_HISS,
    I_ANIMAL, HT_LAND, 15, DEFAULT_ENERGY,
    MU_NOTHING, SIZE_SMALL, MON_SHAPE_ARACHNID,
...

{
    ...
    9, 270,
    4, 12, MST_NO_SPELLS, CE_NOXIOUS, S_SILENT,
    I_ANIMAL, HT_LAND, 15, DEFAULT_ENERGY,
...

{
    ...
    12, 1220,
    12, 6, MST_PLUTONIUM_CRAB, CE_NOXIOUS, S_SILENT, // BCADDO: Bring back mutating meat.
    I_ANIMAL, HT_AMPHIBIOUS, 10, DEFAULT_ENERGY,
    MU_NOTHING, SIZE_SMALL, MON_SHAPE_QUADRUPED,
...

{
    ...
    { { AT_BITE, AF_FIRE, 36 }, { AT_CONSTRICT, AF_CRUSH, 9 },
        AT_NO_ATK, AT_NO_ATK },
    17, 480,
    5, 18, MST_SWAMP_WORM, CE_CLEAN, S_SILENT,
...
// small abominations ('x')
{
    ...
    7, 385,
    5, 10, MST_NO_SPELLS, CE_NOCORPSE, S_GIBBERING,
    I_ANIMAL, HT_LAND, 30, DEFAULT_ENERGY,
...

{
    ...
    10, 695,
    5, 14, MST_SPHINX_MOTH, CE_CLEAN, S_SILENT,
    I_ANIMAL, HT_LAND, 12, DEFAULT_ENERGY,
...

{
    ...
    9, 645,
    3, 18, MST_CHAOS_BUTTERFLY, CE_CLEAN, S_SILENT,
...

{
    ...
    15, 680,
    6, 10, MST_NO_SPELLS, CE_NOCORPSE, S_SILENT,
...

{
    ...
    10, 550,
    11, 10, MST_NO_SPELLS, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
...

{
    ...
    14, 10, MST_DEEP_TROLL_EARTH_MAGE, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
...

{
    ...
    { {AT_BITE, AF_PLAIN, 27}, {AT_CLAW, AF_PLAIN, 20},
      {AT_CLAW, AF_PLAIN, 20}, {AT_SHIELD, AF_PLAIN, 20} },
    12, 480,
    11, 10, MST_DEEP_TROLL_SHAMAN, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    muf(MU_DOOR | MU_EVOKE | MU_ARMOUR | MU_SHIELD), SIZE_LARGE, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 33}, {AT_SHIELD, AF_PLAIN, 33}, 
      {AT_BITE, AF_VAMPIRIC, 15}, AT_NO_ATK },
    11, 715,
    10, 10, MST_VAMPIRE_KNIGHT, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    muf(MU_MELEE | MU_EVOKE), SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 15}, {AT_SHIELD, AF_PLAIN, 15},
      {AT_BITE, AF_VAMPIRIC, 15}, AT_NO_ATK },
    10, 550,
    10, 10, MST_VAMPIRE_MAGE, CE_CLEAN, S_SILENT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    muf(MU_MELEE | MU_EVOKE), SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    12, 420,
    30, 10, MST_SILVER_STAR, CE_NOCORPSE, S_SILENT,
    I_HUMAN, HT_LAND, 10, MOVE_ENERGY(8),
    MU_NOTHING, SIZE_LITTLE, MON_SHAPE_ORB,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 25}, {AT_SHIELD, AF_PLAIN, 25}, AT_NO_ATK, AT_NO_ATK },
    9, 675,
    2, 13, MST_MERFOLK_JAVELINEER, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
...
// "V"ampires.
{
    ...
    { {AT_HIT, AF_PLAIN, 40}, {AT_SHIELD, AF_PLAIN, 40}, 
      {AT_BITE, AF_VAMPIRIC, 15}, AT_NO_ATK },
    18, 1800,
    10, 15, MST_JORY, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    muf(MU_MELEE | MU_EVOKE), SIZE_MEDIUM, MON_SHAPE_HUMANOID,
