...

{
    ...
    M_WARM_BLOOD | M_ARCHER | M_SPEAKS | M_PREFER_RANGED,
    MR_NO_FLAGS,
...

{
    ...
    M_COLD_BLOOD | M_SPEAKS | M_FLIES | M_INVIS,
    mrd(MR_RES_NEG, 3),
...
// Nonbase draconian AC and EV is additive with the base type.
{
    ...
    M_COLD_BLOOD | M_SPEAKS | M_SPELLCASTER,
    MR_NO_FLAGS,
...

{
    ...
    M_COLD_BLOOD | M_SPEAKS | M_SPELLCASTER | M_PREFER_RANGED,
    MR_NO_FLAGS,
    10, MONS_DRACONIAN, MONS_DRACONIAN, MH_NATURAL, 40,
...

{
    ...
    M_WARM_BLOOD | M_FIGHTER | M_SPEAKS | M_SPELLCASTER,
    MR_NO_FLAGS,
...

{
    ...
    M_WARM_BLOOD | M_ARCHER | M_SPEAKS | M_SPELLCASTER,
    MR_NO_FLAGS,
    10, MONS_ELF, MONS_ELF, MH_NATURAL, 80,
    { {AT_HIT, AF_PLAIN, 21}, {AT_SHIELD, AF_PLAIN, 21}, AT_NO_ATK, AT_NO_ATK },
    10, 500,
...

{
    ...
    M_SPEAKS | M_WARM_BLOOD | M_SEE_INVIS | M_SPELLCASTER,
    MR_NO_FLAGS,
...

{
    ...
    M_WARM_BLOOD | M_SEE_INVIS | M_SPEAKS | M_SPELLCASTER,
    MR_NO_FLAGS,
...

{
    ...
    M_SEE_INVIS | M_WARM_BLOOD | M_SPELLCASTER,
    MR_NO_FLAGS,
...

{
    ...
    M_WARM_BLOOD | M_SPEAKS | M_SEE_INVIS | M_SPELLCASTER,
    MR_NO_FLAGS,
    10, MONS_SPRIGGAN, MONS_SPRIGGAN, MH_NATURAL, 100,
...

{
    ...
    M_WARM_BLOOD | M_SPEAKS | M_SEE_INVIS | M_FLIES | M_SPELLCASTER,
    MR_RES_WIND,
...

{
    ...
    M_WARM_BLOOD | M_SPEAKS | M_SPELLCASTER,
    MR_NO_FLAGS,
...

{
    ...
    M_WARM_BLOOD | M_SPEAKS | M_NO_GEN_DERIVED | M_SPELLCASTER,
    MR_NO_FLAGS,
...

{
    ...
    M_SEE_INVIS | M_SPEAKS | M_WARM_BLOOD | M_SPELLCASTER,
    MR_NO_FLAGS,
...

{
    ...
    M_SPEAKS | M_WARM_BLOOD | M_SPELLCASTER,
    MR_NO_FLAGS,
    10, MONS_HUMAN, MONS_HUMAN, MH_NATURAL | MH_EVIL, 60,
    { {AT_HIT, AF_PLAIN, 6}, {AT_SHIELD, AF_PLAIN, 6}, AT_NO_ATK, AT_NO_ATK },
    10, 400,
...

{
    ...
    M_NO_SKELETON | M_FLIES | M_SPELLCASTER | M_FIGHTER | M_COLD_BLOOD,
    MR_VUL_POISON | MR_RES_ACID,
...

{
    ...
    M_WARM_BLOOD | M_SPEAKS | M_ARCHER,
    MR_NO_FLAGS,
...

{
    ...
    M_FIGHTER | M_WARM_BLOOD | M_SEE_INVIS | M_SPEAKS | M_SPELLCASTER,
    mrd(MR_RES_ELEC, 3),
...

{
    ...
    M_WARM_BLOOD | M_SPEAKS | M_FIGHTER | M_SEE_INVIS | M_SPELLCASTER,
...

{
    ...
    M_SEE_INVIS | M_UNBREATHING | M_FLIES | M_SPELLCASTER,
    MR_NO_FLAGS,
...

{
    ...
    M_SEE_INVIS | M_WARM_BLOOD | M_SPEAKS | M_HYBRID | M_FLIES | M_SPELLCASTER,
    MR_NO_FLAGS,
...
// liches ('L')
{
    ...
    M_SEE_INVIS | M_SPEAKS | M_SPELLCASTER,
    mrd(MR_RES_COLD, 2) | MR_VUL_ACID,
...

{
    ...
    M_FIGHTER | M_SEE_INVIS | M_NO_ZOMBIE,
    MR_RES_COLD,
...

{
    ...
    M_SEE_INVIS | M_SPEAKS | M_SPELLCASTER | M_NO_ZOMBIE,
...

{
    ...
    M_FIGHTER | M_SEE_INVIS | M_WARM_BLOOD | M_SPEAKS | M_SPELLCASTER,
    MR_RES_POISON,
...

{
    ...
    M_FIGHTER | M_SEE_INVIS | M_WARM_BLOOD | M_SPEAKS | M_HYBRID | M_FLIES | M_SPELLCASTER,
    MR_NO_FLAGS,
...

{
    ...
    M_WARM_BLOOD | M_SPEAKS | M_NO_POLY_TO | M_NO_GEN_DERIVED | M_STATIONARY,
...

{
    ...
    M_WARM_BLOOD | M_SEE_INVIS | M_UNBLINDABLE | M_SPEAKS | M_SPELLCASTER,
    MR_VUL_ACID,
...

{
    ...
    M_SEE_INVIS | M_SPEAKS | M_BLOOD_SCENT | M_WARM_BLOOD | M_FLIES | M_SPELLCASTER,
    MR_RES_COLD,
...

{
    ...
    M_SEE_INVIS | M_BLOOD_SCENT | M_FIGHTER | M_NO_ZOMBIE,
    MR_RES_COLD,
...

{
    ...
    M_INSUBSTANTIAL | M_UNBREATHING | M_FLIES | M_SPELLCASTER,
...

{
    ...
    M_SEE_INVIS | M_INVIS | M_SPELLCASTER,
    MR_RES_POISON | mrd(MR_RES_COLD, 2) | mrd(MR_RES_NEG, 2),
...

{
    ...
    M_FIGHTER | M_SEE_INVIS | M_FLIES | M_SPELLCASTER,
    MR_RES_POISON | mrd(MR_RES_FIRE, 3) | MR_VUL_COLD | MR_VUL_WATER,
...

{
    ...
    M_SEE_INVIS | M_FAST_REGEN | M_FLIES | M_SPELLCASTER | M_FIGHTER,
...

{
    ...
    M_SEE_INVIS | M_FLIES | M_SPELLCASTER | M_FIGHTER,
    MR_RES_POISON | MR_VUL_FIRE | mrd(MR_RES_COLD, 3),
...

{
    ...
    M_SEE_INVIS | M_SPINY | M_SPELLCASTER | M_FIGHTER,
...

{
    ...
    12, MONS_GOLEM, MONS_ELECTRIC_GOLEM, MH_CONSTRUCT, 180,
...
{   // Monster equivalent of Player Fairy Race for Vaults.
    ...
    M_FLIES | M_NOT_DANGEROUS | M_CONFUSED | M_NO_POLY_TO,
    MR_VUL_POISON | MR_RES_ACID,
...
// unique major demons ('&')
{
    ...
    M_UNIQUE | M_FIGHTER | M_SEE_INVIS | M_SPEAKS | M_TALL_TILE
        | M_GENDER_NEUTRAL | M_SPELLCASTER,
