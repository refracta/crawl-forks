...
int colour_apt(skill_type skill, draconian_colour drac_colour = you.drac_colour);
...
static const skill_type skill_display_order[] =
{
    ...
    SK_WHIPS_FLAILS, SK_AXES_HAMMERS, SK_POLEARMS, SK_MACES_STAVES, SK_UNARMED_COMBAT,
