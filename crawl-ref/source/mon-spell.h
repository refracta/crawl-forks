...
static const mon_spellbook mspell_list[] =
{
	...
	{  MST_BLORK_THE_WHINER,
      {
       { SPELL_CANTRIP, 12, MON_SPELL_WIZARD },
       { SPELL_OZOCUBUS_ARMOUR, 24, MON_SPELL_WIZARD },
       { SPELL_STICKY_FLAME_RANGE, 12, MON_SPELL_WIZARD },
       { SPELL_HASTE, 12, MON_SPELL_WIZARD },
       { SPELL_INVISIBILITY, 12, MON_SPELL_WIZARD | MON_SPELL_EMERGENCY }
      }
    },
	
	{  MST_BLORK_THE_REPENTANT,
      {
       { SPELL_DEFLECT_MISSILES, 24, MON_SPELL_WIZARD },
       { SPELL_OZOCUBUS_ARMOUR, 24, MON_SPELL_WIZARD },
       { SPELL_STICKY_FLAME_RANGE, 12, MON_SPELL_WIZARD },
       { SPELL_HASTE, 12, MON_SPELL_WIZARD },
       { SPELL_INVISIBILITY, 12, MON_SPELL_WIZARD | MON_SPELL_EMERGENCY }
	...
	{  MST_BLORK_THE_GREAT_ORC,
      {
       { SPELL_DEFLECT_MISSILES, 24, MON_SPELL_WIZARD },
       { SPELL_OZOCUBUS_ARMOUR, 24, MON_SPELL_WIZARD },
       { SPELL_STICKY_FLAME_RANGE, 12, MON_SPELL_WIZARD },
       { SPELL_HASTE, 12, MON_SPELL_WIZARD },
       { SPELL_FLASH_FREEZE, 48, MON_SPELL_WIZARD | MON_SPELL_EMERGENCY }
      }
    },
	...
	{  MST_NERGALLE_SOULEATER,
      {
       { SPELL_BOLT_OF_DRAINING, 12, MON_SPELL_WIZARD },
       { SPELL_SUMMON_SPECTRAL_ORCS, 24, MON_SPELL_WIZARD },
	   { SPELL_DRAIN_LIFE, 24, MON_SPELL_WIZARD },
       { SPELL_HASTE_OTHER, 12, MON_SPELL_WIZARD },
      }
    },
	...
	{  MST_NERGALLE_LICH,
      {
       { SPELL_BOLT_OF_DRAINING, 12, MON_SPELL_WIZARD },
	   { SPELL_DISPEL_UNDEAD, 24, MON_SPELL_WIZARD },
       { SPELL_SUMMON_SPECTRAL_ORCS, 24, MON_SPELL_WIZARD },
	   { SPELL_DRAIN_LIFE, 12, MON_SPELL_WIZARD },
	   { SPELL_CALL_LOST_SOUL, 12, MON_SPELL_WIZARD },
       { SPELL_HASTE_OTHER, 12, MON_SPELL_WIZARD },
      }
    },
