...
enum spell_type : int
{
    ...
    SPELL_WAND_HASTING,
    SPELL_THROW_ROCK,
    SPELL_THROW_TOMAHAWK,
    SPELL_THROW_JAVELIN,
    SPELL_THROW_NET,
    SPELL_THROW_BLOWGUN,
    SPELL_THROW_CURARE,
    SPELL_THROW_FRUIT,
    SPELL_THROW_DISPERSAL,
    ...
    SPELL_HAILSTORM,
    SPELL_NOXIOUS_BOG,
    SPELL_BREATHE_VAMPIRIC,
    SPELL_TRIPLE_BREATH,
    SPELL_SILVER_SPLINTERS,
    SPELL_BONE_SHARDS,
    SPELL_BREATHE_CHAOTIC,
    SPELL_BREATHE_RADIATION,
    SPELL_EMPOWERED_BREATH,
    SPELL_SLIME_SHARDS,
    SPELL_SLIME_RUSH,
    SPELL_SACRED_ORDER,
